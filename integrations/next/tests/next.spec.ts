/**
 * Integration tests for @ui-bridge/next — Next.js webpack integration.
 *
 * Verifies that withUiBridge() wires up correctly in the Next.js dev
 * server (demos/next):
 *
...
const ANNOTATIONS_DIR = resolve(NEXT_DEMO_ROOT, '.ui-bridge', 'comments');

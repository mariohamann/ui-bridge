  ...
  static styles = [
    ...
    css`
      ...
      .bar {
        ...
        background: var(--wa-color-neutral-05); border-bottom: 1px solid var(--wa-color-neutral-20);
      ...
      .bar-title strong { color: var(--wa-color-warning-50); }
      .dot { width: 5px; height: 5px; border-radius: 50%; background: var(--wa-color-neutral-20); flex-shrink: 0; }
      .dot.ok { background: var(--wa-color-success-50); }
      ...
      .row {
        ...
        border-bottom: 1px solid color-mix(in srgb, var(--wa-color-neutral-20) 50%, transparent);
        transition: background .1s;
      }
      .row:last-child { border-bottom: none; }
      .row:hover { background: color-mix(in srgb, var(--wa-color-warning-50) 5%, transparent); }
